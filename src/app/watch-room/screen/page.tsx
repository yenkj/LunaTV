...
import { Monitor, MonitorPlay, Users, ArrowLeft } from 'lucide-react';
          ...
          <div className="grid flex-1 grid-cols-1 gap-4 xl:grid-cols-[1fr_320px]">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
                <h2 className="mb-3 font-semibold text-gray-900 dark:text-gray-100">共享状态</h2>
                ...
                {isOwner && (
                  <div className="mt-4">
                    ...
                    <select
                      ...
                      className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 disabled:cursor-not-allowed disabled:bg-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:disabled:bg-gray-800"
                    >
                  ...
                  {isOwner ? (
                    <>
                      <button
                        ...
                        disabled={isStarting || isSharing}
                        className="flex-1 rounded-lg bg-blue-500 px-4 py-2 text-white disabled:bg-gray-400 hover:bg-blue-600 transition-colors"
                      >
                      ...
                      <button
                        ...
                        disabled={!isSharing}
                        className="rounded-lg bg-red-500 px-4 py-2 text-white disabled:bg-gray-400 hover:bg-red-600 transition-colors"
                      >
                        停止
                      </button>
                    </>
