...
function LoginPageClient() {
  ...
  return (
    <div className='absolute inset-0 -m-4 sm:-m-6 md:-m-8 lg:-m-12 xl:-m-16 2xl:-m-20 flex items-center justify-center px-3 sm:px-4 py-8 sm:py-0 overflow-hidden bg-gradient-to-br from-purple-100 via-blue-50 to-pink-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900'>
      {/* Bing 每日壁纸背景 */}
      {bingWallpaper && (
        <div
